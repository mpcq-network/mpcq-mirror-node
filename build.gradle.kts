...
dependencies {
    constraints {
        ...
        api("com.mpcq.hashgraph:app:0.68.0")
        api("com.mpcq.evm:hedera-evm:0.54.2")
        api("com.mpcq.hashgraph:hedera-protobuf-java-api:0.68.0")
        api("com.mpcq.hashgraph:sdk:2.64.0")
