...
contract Airdrop is MPCQTokenService {
    ...
    function tokenAirdrop(address token, address sender, address receiver, int64 amount) public payable returns (int64 responseCode) {
        IMPCQTokenService.TokenTransferList[] memory tokenTransfers = new IMPCQTokenService.TokenTransferList[](1);
        IMPCQTokenService.TokenTransferList memory airdrop;
    ...
    function nftAirdrop(address token, address sender, address receiver, int64 serial) public payable returns (int64 responseCode) {
        ...
        airdrop.token = token;
        IMPCQTokenService.NftTransfer memory nftTransfer = prepareNftTransfer(sender, receiver, serial);
        IMPCQTokenService.NftTransfer[] memory nftTransfers = new IMPCQTokenService.NftTransfer[](1);
    ...
    function tokenNAmountAirdrops(address[] memory tokens, address[] memory senders, address[] memory receivers, int64 amount) public payable returns (int64 responseCode) {
        ...
        IMPCQTokenService.TokenTransferList[] memory tokenTransfers = new IMPCQTokenService.TokenTransferList[](length);
    ...
    function tokenAirdropDistribute(address token, address sender, address[] memory receivers, int64 amount) public payable returns (int64 responseCode) {
        ...
        IMPCQTokenService.TokenTransferList memory airdrop;
        airdrop.token = token;
        IMPCQTokenService.AccountAmount memory senderAA;
        ...
        IMPCQTokenService.AccountAmount[] memory transfers = new IMPCQTokenService.AccountAmount[](length);
        transfers[0] = senderAA;
        for (uint i = 1; i < length; i++)
        {
            IMPCQTokenService.AccountAmount memory receiverAA;
    ...
    function nftAirdropDistribute(address token, address sender, address[] memory receivers) public payable returns (int64 responseCode) {
        ...
        IMPCQTokenService.TokenTransferList memory airdrop;
        airdrop.token = token;
        IMPCQTokenService.NftTransfer[] memory nftTransfers = new IMPCQTokenService.NftTransfer[](length);
        int64 serial = 1;
    ...
    public payable returns (int64 responseCode) {
        ...
        for (uint256 i = 0; i < length; i++)
        {
            ...
            senderAA.amount = -totalAmount;
            IMPCQTokenService.AccountAmount[] memory transfers = new IMPCQTokenService.AccountAmount[](receiversLength + 1);
            transfers[0] = senderAA;
    ...
    function prepareAA(address sender, address receiver, int64 amount) internal pure returns (IMPCQTokenService.AccountAmount[] memory transfers) {
        IMPCQTokenService.AccountAmount memory aa1;
        aa1.accountID = sender;
        aa1.amount = -amount;
        IMPCQTokenService.AccountAmount memory aa2;
        aa2.accountID = receiver;
        aa2.amount = amount;
        transfers = new IMPCQTokenService.AccountAmount[](2);
        transfers[0] = aa1;
        transfers[1] = aa2;
        return transfers;
    }

    function prepareNftTransfer(address sender, address receiver, int64 serial) internal pure returns (IMPCQTokenService.NftTransfer memory nftTransfer) {
