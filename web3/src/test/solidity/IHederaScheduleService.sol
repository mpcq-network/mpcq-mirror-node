...
interface IMPCQScheduleService {
    ...
    function getScheduledCreateFungibleTokenInfo(address scheduleAddress) external returns (int64 responseCode, IMPCQTokenService.FungibleTokenInfo memory fungibleTokenInfo);
    ...
    function getScheduledCreateNonFungibleTokenInfo(address scheduleAddress) external returns (int64 responseCode, IMPCQTokenService.NonFungibleTokenInfo memory nonFungibleTokenInfo);
