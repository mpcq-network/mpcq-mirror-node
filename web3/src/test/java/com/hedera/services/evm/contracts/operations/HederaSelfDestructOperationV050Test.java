...
class MPCQSelfDestructOperationV050Test {
    ...
    private MPCQSelfDestructOperationV050 subject;

    @BeforeEach
    void setUp() {
        subject = new MPCQSelfDestructOperationV050(gasCalculator, addressValidator, systemAccountDetector);
