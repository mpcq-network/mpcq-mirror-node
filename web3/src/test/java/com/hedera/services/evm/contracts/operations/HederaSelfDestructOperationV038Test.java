...
class MPCQSelfDestructOperationV038Test {
    ...
    private MPCQSelfDestructOperationV038 subject;

    @BeforeEach
    void setUp() {
        subject = new MPCQSelfDestructOperationV038(gasCalculator, addressValidator, systemAccountDetector);
