...
import static com.mpcq.services.store.contracts.precompile.HTSTestsUtil.FUNGIBLE;
...
import static com.mpcq.services.store.contracts.precompile.impl.WipeFungiblePrecompile.getWipeWrapper;
...
class WipeFungiblePrecompileTest {
    ...
    void setUp() throws IOException {
        ...
        canonicalPrices.put(
                MPCQFunctionality.TokenAccountWipe, Map.of(SubType.TOKEN_FUNGIBLE_COMMON, BigDecimal.valueOf(0)));
