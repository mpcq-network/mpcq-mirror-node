...
import static com.mpcq.services.store.contracts.precompile.AbiConstants.ABI_ID_UNFREEZE;
import static com.mpcq.services.store.contracts.precompile.HTSTestsUtil.*;
import static com.mpcq.services.store.contracts.precompile.impl.UnfreezeTokenPrecompile.decodeUnfreeze;
...
class UnfreezeTokenPrecompileTest {
    ...
    void setUp() throws IOException {
        ...
        canonicalPrices.put(MPCQFunctionality.TokenUnfreezeAccount, Map.of(SubType.DEFAULT, BigDecimal.valueOf(0)));
