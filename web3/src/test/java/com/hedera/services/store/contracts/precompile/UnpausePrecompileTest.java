...
import static com.mpcq.services.store.contracts.precompile.AbiConstants.ABI_ID_UNPAUSE_TOKEN;
import static com.mpcq.services.store.contracts.precompile.HTSTestsUtil.*;
import static com.mpcq.services.store.contracts.precompile.impl.UnpausePrecompile.decodeUnpause;
...
class UnpausePrecompileTest {
    ...
    void setUp() throws IOException {
        ...
        canonicalPrices.put(MPCQFunctionality.TokenUnpause, Map.of(SubType.DEFAULT, BigDecimal.valueOf(0)));
