...
import static com.mpcq.services.store.contracts.precompile.HTSTestsUtil.nonFungible;
...
import static com.mpcq.services.store.contracts.precompile.impl.WipeNonFungiblePrecompile.decodeWipeNFT;
...
class WipeNonFungiblePrecompileTest {
    ...
    void setUp() throws IOException {
        ...
        canonicalPrices.put(
                MPCQFunctionality.TokenAccountWipe, Map.of(SubType.TOKEN_NON_FUNGIBLE_UNIQUE, BigDecimal.valueOf(0)));
