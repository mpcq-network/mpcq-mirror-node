...
import static com.mpcq.services.store.contracts.precompile.impl.BurnPrecompile.getBurnWrapper;
...
class BurnPrecompileTest {
    ...
    void setUp() throws IOException {
        ...
        canonicalPrices.put(
                MPCQFunctionality.TokenBurn, Map.of(SubType.TOKEN_FUNGIBLE_COMMON, BigDecimal.valueOf(0)));
