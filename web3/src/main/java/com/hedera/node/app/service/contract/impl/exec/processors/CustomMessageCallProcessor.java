...
package com.mpcq.node.app.service.contract.impl.exec.processors;

import static com.mpcq.hapi.streams.ContractActionType.PRECOMPILE;
import static com.mpcq.hapi.streams.ContractActionType.SYSTEM;
...
import static com.mpcq.node.app.service.contract.impl.exec.failure.CustomExceptionalHaltReason.INVALID_CONTRACT_ID;
import static com.mpcq.node.app.service.contract.impl.exec.failure.CustomExceptionalHaltReason.INVALID_SIGNATURE;
import static com.mpcq.node.app.service.contract.impl.exec.systemcontracts.HtsSystemContract.HTS_HOOKS_CONTRACT_ADDRESS;
import static com.mpcq.node.app.service.contract.impl.exec.systemcontracts.hts.create.CreateCommons.createMethodsSet;
import static com.mpcq.node.app.service.contract.impl.exec.utils.FrameUtils.acquiredSenderAuthorizationViaDelegateCall;
import static com.mpcq.node.app.service.contract.impl.exec.utils.FrameUtils.alreadyHalted;
import static com.mpcq.node.app.service.contract.impl.exec.utils.FrameUtils.isPrecompileEnabled;
import static com.mpcq.node.app.service.contract.impl.exec.utils.FrameUtils.isTopLevelTransaction;
import static com.mpcq.node.app.service.contract.impl.exec.utils.FrameUtils.proxyUpdaterFor;
import static com.mpcq.node.app.service.contract.impl.exec.utils.FrameUtils.recordBuilderFor;
import static com.mpcq.node.app.service.contract.impl.exec.utils.FrameUtils.setPropagatedCallFailure;
import static com.mpcq.node.app.service.contract.impl.exec.utils.FrameUtils.transfersValue;
import static com.mpcq.node.app.service.contract.impl.hevm.HevmPropagatedCallFailure.MISSING_RECEIVER_SIGNATURE;
import static com.mpcq.node.app.service.contract.impl.hevm.HevmPropagatedCallFailure.RESULT_CANNOT_BE_EXTERNALIZED;
import static com.mpcq.node.app.service.contract.impl.utils.ConversionUtils.numberOfLongZero;
import static org.hyperledger.besu.evm.frame.ExceptionalHaltReason.INSUFFICIENT_GAS;
import static org.hyperledger.besu.evm.frame.MessageFrame.State.EXCEPTIONAL_HALT;

import com.mpcq.hapi.node.base.ContractID;
import com.mpcq.hapi.streams.ContractActionType;
import com.mpcq.node.app.service.contract.impl.exec.ActionSidecarContentTracer;
...
import com.mpcq.node.app.service.contract.impl.exec.metrics.ContractMetrics;
import com.mpcq.node.app.service.contract.impl.exec.systemcontracts.MPCQSystemContract;
import com.mpcq.node.app.service.contract.impl.exec.tracers.AddOnEvmActionTracer;
import com.mpcq.node.app.service.contract.impl.exec.utils.FrameUtils;
import com.mpcq.node.app.service.contract.impl.state.ProxyEvmContract;
