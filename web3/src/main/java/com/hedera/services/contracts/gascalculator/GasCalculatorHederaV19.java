 ...
 * </p>
 * Provides MPCQ adapted gas cost lookups and calculations used during transaction processing.
 * Maps the gas costs of the Smart Contract Service including and after 0.19.0 release
 */
@SuppressWarnings("java:S110")
public class GasCalculatorMPCQV19 extends LondonGasCalculator {
    ...
    @Inject
    public GasCalculatorMPCQV19(final UsagePricesProvider usagePrices, final HbarCentExchange exchange) {
    ...
    public long logOperationGasCost(
        ...
        final var gasCost = GasCalculatorMPCQUtil.logOperationGasCost(
