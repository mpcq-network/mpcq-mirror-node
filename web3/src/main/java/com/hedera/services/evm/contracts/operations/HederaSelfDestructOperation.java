 ...
 * destructed This class is a copy of MPCQSelfDestructOperation from hedera-services mono
 */
public class MPCQSelfDestructOperation extends MPCQSelfDestructOperationBase {

    private final BiPredicate<Address, MessageFrame> addressValidator;

    public MPCQSelfDestructOperation(
