...
import com.mpcq.node.app.service.evm.contracts.operations.MPCQExtCodeHashOperation;
import com.mpcq.node.app.service.evm.contracts.operations.MPCQExtCodeHashOperationV038;
...
import com.mpcq.services.fees.calculation.UsageBasedFeeCalculator;
import com.mpcq.services.fees.calculation.UsagePricesProvider;
import com.mpcq.services.fees.calculation.crypto.queries.GetTxnRecordResourceUsage;
import com.mpcq.services.fees.calculation.token.txns.TokenAssociateResourceUsage;
import com.mpcq.services.fees.calculation.token.txns.TokenDeleteResourceUsage;
import com.mpcq.services.fees.calculation.token.txns.TokenDissociateResourceUsage;
import com.mpcq.services.fees.calculation.token.txns.TokenUpdateResourceUsage;
import com.mpcq.services.fees.calculation.utils.AccessorBasedUsages;
import com.mpcq.services.fees.calculation.utils.OpUsageCtxHelper;
...
import com.mpcq.services.store.contracts.precompile.impl.AllowancePrecompile;
...
import com.mpcq.services.store.contracts.precompile.impl.BurnPrecompile;
import com.mpcq.services.store.contracts.precompile.impl.DeleteTokenPrecompile;
...
import com.mpcq.services.store.contracts.precompile.impl.GetApprovedPrecompile;
import com.mpcq.services.store.contracts.precompile.impl.GrantKycPrecompile;
import com.mpcq.services.store.contracts.precompile.impl.IsApprovedForAllPrecompile;
import com.mpcq.services.store.contracts.precompile.impl.MintPrecompile;
import com.mpcq.services.store.contracts.precompile.impl.MultiAssociatePrecompile;
import com.mpcq.services.store.contracts.precompile.impl.MultiDissociatePrecompile;
import com.mpcq.services.store.contracts.precompile.impl.PausePrecompile;
import com.mpcq.services.store.contracts.precompile.impl.RevokeKycPrecompile;
import com.mpcq.services.store.contracts.precompile.impl.SetApprovalForAllPrecompile;
import com.mpcq.services.store.contracts.precompile.impl.TokenCreatePrecompile;
import com.mpcq.services.store.contracts.precompile.impl.TokenUpdateKeysPrecompile;
...
import com.mpcq.services.store.contracts.precompile.impl.UnfreezeTokenPrecompile;
import com.mpcq.services.store.contracts.precompile.impl.UnpausePrecompile;
import com.mpcq.services.store.contracts.precompile.impl.UpdateTokenExpiryInfoPrecompile;
import com.mpcq.services.store.contracts.precompile.impl.WipeFungiblePrecompile;
import com.mpcq.services.store.contracts.precompile.impl.WipeNonFungiblePrecompile;
...
import com.mpcq.services.txn.token.BurnLogic;
...
import com.mpcq.services.txn.token.GrantKycLogic;
...
import com.mpcq.services.txn.token.UnfreezeLogic;
import com.mpcq.services.txn.token.UnpauseLogic;
...
/**
 * Spring configuration for beans related to com.mpcq.services components
 */
@Configuration
